...
const Multiproduct = () => {
    ...
    const renderss = Multiproduct.map((productset) => {
        const { id, title, Price, Url, Content } = productset;
        return (
            <>
                    ...
                    //     <div className="col-3"> */}
                            ...
                            <div className="card border-primary mb-3">
                                ...
                                <div className="card-body">
                                    ...
                                    <Button variant="primary" className="me-2" onClick={(e) => handleEdit(e, productset.id)}>Edit</Button>

                                    <Button variant="danger" onClick={(e) => handleDelete(e, productset.id)}>Delete</Button>
